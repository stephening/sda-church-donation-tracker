...
Donations will be entered in batches, and the category subtotals from a batch will be entered into a General Ledger (GL) accounting program. Batches can be viewed or edited after they are entered. There will be two types of batches, AG and manually entered donations collected at church.
