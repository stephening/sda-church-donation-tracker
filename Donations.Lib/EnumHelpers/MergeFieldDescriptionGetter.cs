...
/// </summary>
public class MergeFieldDescriptionGetter : MarkupExtension
{
	private readonly Type _type;

	public MergeFieldDescriptionGetter(Type type)
	{
		_type = type;
	}
	...
	public override object ProvideValue(IServiceProvider serviceProvider)
	{
		return Enum.GetValues(_type)
			.Cast<object>()
			.Select(e => new { Value = e, DisplayName = Helper.GetDescription((enumMergeFields)e) });
	}
}
