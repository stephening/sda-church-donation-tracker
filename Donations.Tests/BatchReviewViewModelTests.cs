...
{
	public class BatchReviewViewModelTests
	{
		[Theory]
		[InlineData(true)]
		[InlineData(false)]
		...
		{
			// Arrange
			BatchReviewViewModel obj = new BatchReviewViewModel() { HasChanges = expected };
		...
		{
			// Arrange
			BatchReviewViewModel obj = new BatchReviewViewModel() { BatchDate = param };
		...
		{
			// Arrange
			BatchReviewViewModel obj = new BatchReviewViewModel() { BatchNote = expected };
		...
		{
			// Arrange
			BatchReviewViewModel obj = new BatchReviewViewModel() { BatchTotal = expected };
		...
		public void Review()
		{
			...
			BatchReviewViewModel obj = new BatchReviewViewModel();
