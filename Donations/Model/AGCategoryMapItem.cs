...
namespace Donations.Model
{
	...
	public class AGCategoryMapItem
	{
		...
		/// </summary>
		[JsonIgnore]
		public string? CategoryDescription => (null != di.Data.CatDict && di.Data.CatDict.ContainsKey(CategoryCode)) ? di.Data.CatDict[CategoryCode].Description : "";
		/// <summary>
		...
		/// </summary>
		/// <returns>Copy of AGCategoryMapItem</returns>
		public AGCategoryMapItem Copy()
		{
			return new AGCategoryMapItem()
			{
				AGCategoryCode = AGCategoryCode,
				AGCategoryName = AGCategoryName,
