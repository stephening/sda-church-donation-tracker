...
namespace Donations.View
{
	...
	public partial class DonorInputView : UserControl
	{
		...
		private void Click_Submit(object sender, System.Windows.RoutedEventArgs e)
		{
			_viewModel?.SubmitDonor();
			SummaryGrid.SelectedIndex = -1;
		}

		private void ChangeCategory(object sender, System.Windows.Input.MouseButtonEventArgs e)
		{
			if (_ignoreClick)
			{
		...
		private void EnvelopeBody_KeyUp(object sender, System.Windows.Input.KeyEventArgs e)
		{
